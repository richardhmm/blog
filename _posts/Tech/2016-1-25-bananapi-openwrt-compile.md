...
定制界面:
![定制界面](/blog/images/bananapi/make_menuconfig.png)

Target System默认为BananaPi，且只有BananaPi可选，TargetProfile中选择你的BPi型号，支持BPI-M1，BPI-M1-Plus和BPI-R1三种机型，这里我选择的是BPI-M1.

~~~
Target System (BananaPi)  ---> 
Target Profile (BPI-M1)  --->

[*] Build the OpenWrt SDK # 方便后续应用ipk编译调试使用

LuCI—> 1. Collections  ---> <*> luci  # 添加Luci支持，通俗点讲就是web界面支持，默认选择
LuCI—>2. Modules  ---> Translations  ---> <*> English (en)   # 添加英文支持
LuCI—>2. Modules  ---> Translations  ---> <*> Chinese (zh-cn)   #添加中文，这里你也可以选择其他语言
LuCI—>3. Applications  ---> <*> luci-app-commands.............................. LuCI Shell Command Module   # 方便调试查询
LuCI—>3. Applications  ---> <*> luci-app-mwan3   # 多WAN带宽叠加
LuCI—>3. Applications  ---> <*> luci-app-ntpc   # NTP网络时间客户端
LuCI—>3. Applications  ---> <*> luci-app-samba # 网络共享服务
LuCI—>5. Protocols  ---> <*> luci-proto-3g # 支持3g上网功能模块
~~~
详细的配置文件, 见后面的"附件(.config)".
...
CONFIG_DEFAULT_kmod-eeprom-sunxi=y
CONFIG_DEFAULT_kmod-nf-nathelper=y
CONFIG_DEFAULT_kmod-rtc-sunxi=y
CONFIG_DEFAULT_kmod-wdt-sunxi=y
...
CONFIG_DEFAULT_uboot-sunxi-BPI-M1=y
CONFIG_DEFAULT_uboot-sunxi-BPI-M1-Plus=y
CONFIG_DEFAULT_uboot-sunxi-BPI-R1=y
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_USE_SENDFILE is not set
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_FTP_AUTHENTICATION is not set
...
# Boot Loaders
#
CONFIG_PACKAGE_uboot-sunxi-BPI-M1=y
CONFIG_PACKAGE_uboot-sunxi-BPI-M1-Plus=y
CONFIG_PACKAGE_uboot-sunxi-BPI-R1=y
...
# CONFIG_PACKAGE_libresample is not set
...
# CONFIG_PACKAGE_libwebsockets-cyassl is not set
...
# CONFIG_PACKAGE_shairport-sync is not set
